        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              {/* ### Anda mahasiswa? staff organisasi? atau butuh bantuan mengerjakan
              tugas? Kami siap membantu tugas-tugas anda. */}{" "}
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non
              necessitatibus recusandae libero ipsam reprehenderit praesentium
              corrupti earum nobis quis!
            </p>
